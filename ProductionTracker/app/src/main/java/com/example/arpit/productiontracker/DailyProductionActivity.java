...
public class DailyProductionActivity extends AppCompatActivity {
    ...
    private static String url_all_products = "https://ps1project.herokuapp.com/get_items.php";
    // JSON Node names
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new LoadAllProducts(DailyProductionActivity.this).execute();
    }
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            JSONObject jsonObject = jsonParser.makeHttpRequest(url_all_products, "GET", params);
        ...
        protected void onPostExecute(String s) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (success == 1) {
                        Toast.makeText(DailyProductionActivity.this, "Updated", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(DailyProductionActivity.this, "No Records Found", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
